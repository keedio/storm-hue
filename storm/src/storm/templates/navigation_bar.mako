    ...
    <div class="card card-small">
      ...
      <div class="btn-group pull-right" style="display: inline; align: left">
         <div id="upload-dropdown" class="btn-group" style="vertical-align: middle">
            <a href="#" class="btn dropdown-toggle" title="${ _('Create topology') }" data-toggle="dropdown">
               <i class="fa fa-arrow-circle-o-up"></i> 
               ${ _('Create topology') }
               <span class="caret"></span>	
            </a>
            <ul class="dropdown-menu">
               <li><a href="#" data-target="#tblSubmitTopology" class="btn" data-toggle="modal" title="${ _('Submit a new topology') }"><i class="fa fa-plus-circle"></i> Submit</a></li>                     
               <li><a href="#" data-target="#tblSaveTopology" class="btn" data-toggle="modal" title="${ _('Save to HDFS') }"><i class="fa fa-floppy-o"></i> Save to HDFS</a></li>                     
            </ul>
         </div>
      </div>
      -->            
          ...
          <ul class="nav">
            ...
            <li class="${is_selected(section, 'Cluster Summary')}">
             ...
             <li class="${is_selected(section, 'Nimbus Configuration')}">
               <a href="${url('storm:nimbus_configuration')}"> ${ _('Nimbus Configuration') } </a>
            </li>                       
          </ul>
        </div>
      </div>
