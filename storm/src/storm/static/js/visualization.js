...
var should_update;
function show_visualization(sys, topology_id, jsonVisualization) {
    ...
    if(sys == null)
    {
        ...
        $(".stream-box").click(function () { rechoose(topology_data, sys, this); console.log(this); });    
    }
	...
	*/
    ...
    $("#show-hide-visualization").click(function () { hide_visualization(sys, topology_id, jsonVisualization) });
}

function hide_visualization(sys, topology_id, jsonVisualization) {
    should_update = false;
    $("#visualization-container").hide(500);
    $("#show-hide-visualization").attr('value', 'Show Visualization');
    $("#show-hide-visualization").unbind("click");
    $("#show-hide-visualization").click(function () { show_visualization(sys, topology_id, jsonVisualization) });
}
